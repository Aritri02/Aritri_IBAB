...
print("Logistic Regression model accuracy without normalization(in %):", acc*100)
...
y_pred = model.predict(X_test)
acc=accuracy_score(y_test, y_pred)
print("Logistic Regression model accuracy with normalization from scratch(in %):", acc*100)